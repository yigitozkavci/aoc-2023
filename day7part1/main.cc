...
int hand_type(const string &hand)
{
  ...
  {
    return freq_equal(card_freqs, {1, 1, 1, 2});
  };
  ...
  for (int i = 0; i < hand_functions.size(); i++)
  {
...
{
  vector<char> cards_by_strength{'A', 'K', 'Q', 'J', 'T', '9', '8', '7', '6', '5', '4', '3', '2'};
...
bool compare_cards(const string &c1, const string &c2)
{
  ...
  // Lower the type index is stronger the hand is.
  if (type1 > type2)
  {
    return true;
  }
